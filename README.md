...
| Поле | Значення |
| --- | --- |
| Прізвище та ім'я | Воробей Юрій Вікторович |
| GitHub-логін | yura678 |
| Підгрупа | КН-41 |
| Тема проєкту | Телеграм-бот деканату: довідки, черга на консультації, оголошення |
| Варіант вхідних умов | V08 |
| Трекер | |
| Дошка | |
| Валюта проєкту | |
| Contingency, % | |

### Опис семестрового проєкту
Проєкт присвячений створенню інтелектуального телеграм-бота для факультету/деканату, що автоматизує рутинні сервіси студентського документообігу: оформлення онлайн-запитів на академічні довідки та витяги, запис в електронну чергу на консультації до викладачів і адміністрації, а також таргетоване сповіщення студентських груп про зміни в розкладі та важливі оголошення. Рішення скорочує час обробки звернень, усуває живі черги в деканаті та забезпечує цілодобову доступність адміністративних сервісів.
